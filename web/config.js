...
export const birthColumns = ['name', 'surname', 'date_of_birth', 'place_of_birth', 'link', 'contributor'];
export const familyColumns = ['husband_name', 'husband_surname', 'wife_name', 'wife_surname', 'parents', 'children', 'date_of_marriage', 'place_of_marriage', 'link', 'contributor'];
export const deathColumns = ['name', 'surname', 'date_of_death', 'place_of_death', 'link', 'contributor'];

// Columns excluded from the search form (display-only in results table)
export const DISPLAY_ONLY_COLUMNS = new Set(['link', 'parents']);
