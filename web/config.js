...
export const familyColumns = ['husband_name', 'husband_surname', 'husband_parents', 'wife_name', 'wife_surname', 'wife_parents', 'children', 'date_of_marriage', 'place_of_marriage', 'link', 'contributor'];
