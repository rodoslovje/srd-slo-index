...
const translations = {
  en: {
    ...
    matches_found_intro: 'We have found following genealogists have matching or similar data as',
  ...
  sl: {
    ...
    matches_found_intro: 'Našli smo naslednje rodoslovce, ki imajo ujemajoče se ali podobne podatke kot',
  ...
  de: {
    ...
    matches_found_intro: 'Wir haben folgende Genealogen gefunden, die übereinstimmende oder ähnliche Daten haben wie',
