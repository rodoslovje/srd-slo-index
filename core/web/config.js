...
export const birthColumns = ['name', 'surname', 'parents', 'partners', 'date_of_birth', 'place_of_birth', 'links', 'contributor'];
...
export const deathColumns = ['name', 'surname', 'parents', 'partners', 'date_of_death', 'place_of_death', 'links', 'contributor'];
